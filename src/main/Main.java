...
//			AssignmentProblem s1v1 = new AssignmentProblem(s1InputPath + "turmas.csv", s1InputPath + "compostos.csv", s1InputPath + "escolhas.csv", s1InputPath + "m√©dias.csv", "1", true, s1v1OutputPath);
//			s1v1.run();
			
//			String s1v4OutputPath = "res" + File.separator + "output" + File.separator + "s1v4" + File.separator;
//			AssignmentProblem s1v4 = new AssignmentProblem(coursesFilename, s1InputPath + "turmas.csv", s1InputPath + "hor√°rio.csv", s1InputPath + "compostos.csv", s1InputPath + "escolhas.csv", s1InputPath + "m√©dias.csv", 1, "4", true, AssignmentProblem.PreferenceWeightingMode.EXPONENT, s1v4OutputPath);
//			s1v4.run();
...
//			AssignmentProblem s2v2 = new AssignmentProblem(coursesFilename, s2InputPath + "turmas.csv", s2InputPath + "hor√°rio.csv", s2InputPath + "compostos.csv", s2InputPath + "escolhas.csv", s2InputPath + "m√©dias.csv", 2, "2", false, AssignmentProblem.PreferenceWeightingMode.EXPONENT, s2v2OutputPath);
//			s2v2.run();
			...
			AssignmentProblem s1v4 = new AssignmentProblem(coursesFilename, s2InputPath + "turmas.csv", s2InputPath + "hor·rio.csv", s2InputPath + "compostos.csv",
					s2InputPath + "escolhas.csv", s2InputPath + "mÈdias.csv", s2InputPath + "inscriÁıes.csv", 2, "4", true, AssignmentProblem.PreferenceWeightingMode.EXPONENT,
